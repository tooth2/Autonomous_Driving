...
os.environ["IMAGEIO_FFMPEG_EXE"] = "/opt/carnd_p3/behavioral/lib/python3.5/site-packages/imageio/plugins/ffmpeg"
def main():
    ...
    #clip = ffmpeg_extract_subclip(image_list, fps=args.fps)
